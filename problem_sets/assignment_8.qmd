...
Same: values filtered are constant (99, 999, 99, and 999 for all data sets)
Different: variable names must be different, different CSV's read despite presumably same format
